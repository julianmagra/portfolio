...
const Footer = () => {
  ...
  return (
    ...
    <footer
      ...
      id="contact"
    >
      <div className="rounded-lg w-full mx-auto md:flex md:items-center md:justify-between py-4">
        <p className="text-sm text-left md:text-center text-zinc-800/90 dark:text-zinc-200/90">
